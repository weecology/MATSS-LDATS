...
# )
#
#datasets = rbind(datasets, notransients_datasets)

analyses <- build_ldats_analyses_plan(datasets, max_topics = 5, nchangepoints = c(0:1), formulas = c("time", "intercept"), nseeds = 5, ts_control = list(nit = 100))
